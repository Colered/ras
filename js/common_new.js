...
//function to show hide program cycles
function show_hide_cycle_clone(selval,programId){
	//alert(selval+programId);
	$('#firstCycle-'+programId).hide();
	$('#secondCycle-'+programId).hide();
	$('#thirdCycle-'+programId).hide();
	if(selval==1){
	  $('#firstCycle-'+programId).show();
	}else if(selval==2){
	  $('#firstCycle-'+programId).show();
	  $('#secondCycle-'+programId).show();
	}else if(selval==3){
	  $('#firstCycle-'+programId).show();
	  $('#secondCycle-'+programId).show();
	  $('#thirdCycle-'+programId).show();
	}
}
function showCycleDetailsclone($week,$programId){
	if($week == "1w")
	{
		$("#custtd_leftc1w1-"+$programId).show();
		$("#c1week1-"+$programId).show();
		$("#custtd_leftc1w2-"+$programId).hide();
		$("#c1week2-"+$programId).hide();

	}else{
		$("#custtd_leftc1w1-"+$programId).show();		
		$("#c1week1-"+$programId).show();
		$("#custtd_leftc1w2-"+$programId).show();
		$("#c1week2-"+$programId).show();
	}
}
function showCycleDetailstwoclone($week,$programId){
	if($week == "1w")
	{
		$("#custtd_leftc2w1-"+$programId).show();
		$("#c2week1-"+$programId).show();
		$("#custtd_leftc2w2-"+$programId).hide();
		$("#c2week2-"+$programId).hide();
	}else{
		$("#custtd_leftc2w1-"+$programId).show();		
		$("#c2week1-"+$programId).show();
		$("#custtd_leftc2w2-"+$programId).show();
		$("#c2week2-"+$programId).show();
	}
}
function showCycleDetailsthreeclone($week,$programId){
	if($week == "1w")
	{
		$("#custtd_leftc3w1-"+$programId).show();
		$("#c3week1-"+$programId).show();
		$("#custtd_leftc3w2-"+$programId).hide();
		$("#c3week2-"+$programId).hide();

	}else{
		$("#custtd_leftc3w1-"+$programId).show();		
		$("#c3week1-"+$programId).show();
		$("#custtd_leftc3w2-"+$programId).show();
		$("#c3week2-"+$programId).show();
	}
}
function showTimeSlotsClone($programId){	
  	 for ( var i = 0; i <= 5; i++ ){
		cyc1_wk1 = '#c1-w1-'+i+'-'+$programId;		
		ts_avail_cyc1_wk1 = '#ts-avail-c1-w1-'+i+'-'+$programId;
		cyc1_wk2 = '#c1-w2-'+i+'-'+$programId;
		ts_avail_cyc1_wk2 = '#ts-avail-c1-w2-'+i+'-'+$programId;
		cyc2_wk1 = '#c2-w1-'+i+'-'+$programId;
		ts_avail_cyc2_wk1 = '#ts-avail-c2-w1-'+i+'-'+$programId;
		cyc2_wk2 = '#c2-w2-'+i+'-'+$programId;
		ts_avail_cyc2_wk2 = '#ts-avail-c2-w2-'+i+'-'+$programId;
		cyc3_wk1 = '#c3-w1-'+i+'-'+$programId;
		ts_avail_cyc3_wk1 = '#ts-avail-c3-w1-'+i+'-'+$programId;
		cyc3_wk2 = '#c3-w2-'+i+'-'+$programId;
		ts_avail_cyc3_wk2 = '#ts-avail-c3-w2-'+i+'-'+$programId;
		if($(cyc1_wk1).prop('checked') == true){
			$(ts_avail_cyc1_wk1).show();
		}
		if($(cyc1_wk2).prop('checked') == true){
 ...
 //function to show hide time slot at program cycle page
function showHideTimeslots($programId){
	for ( var i = 0; i <= 5; i++ )
	{
		$("#ts-avail-c1-w1-"+i+"-"+$programId).hide();
		$("#ts-avail-c1-w2-"+i+"-"+$programId).hide();
		$("#ts-avail-c2-w1-"+i+"-"+$programId).hide();
		$("#ts-avail-c2-w2-"+i+"-"+$programId).hide();
		$("#ts-avail-c3-w1-"+i+"-"+$programId).hide();
		$("#ts-avail-c3-w2-"+i+"-"+$programId).hide();
	}	
		   $('input[class=days]').click(function(){
            if($(this).attr("value")=="Mon1C1W1-"+$programId){
				$("#ts-avail-c1-w1-0-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w1-0-"+$programId).toggle();
			}else if($(this).attr("value")=="Mon2C1W2-"+$programId){
				$("#ts-avail-c1-w2-0-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w2-0-"+$programId).toggle();
			}else if($(this).attr("value")=="MonC2W1-"+$programId){
				$("#ts-avail-c2-w1-0-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w1-0-"+$programId).toggle();
			}else if($(this).attr("value")=="MonC2W2-"+$programId){
				$("#ts-avail-c2-w2-0-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w2-0-"+$programId).toggle();
			}else if($(this).attr("value")=="MonC3W1-"+$programId){
				$("#ts-avail-c3-w1-0-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w1-0-"+$programId).toggle();
			}else if($(this).attr("value")=="MonC3W2-"+$programId){
				$("#ts-avail-c3-w2-0-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w2-0-"+$programId).toggle();
			}
            if($(this).attr("value")=="Tue1C1W1-"+$programId){
				$("#ts-avail-c1-w1-1-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w1-1-"+$programId).toggle();
            }else if($(this).attr("value")=="Tue2C1W2-"+$programId){
				$("#ts-avail-c1-w2-1-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w2-1-"+$programId).toggle();
            }else if($(this).attr("value")=="TueC2W1-"+$programId){
				$("#ts-avail-c2-w1-1-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w1-1-"+$programId).toggle();
            }else if($(this).attr("value")=="TueC2W2-"+$programId){
				$("#ts-avail-c2-w2-1-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w2-1-"+$programId).toggle();
            }else if($(this).attr("value")=="TueC3W1-"+$programId){
				$("#ts-avail-c3-w1-1-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w1-1-"+$programId).toggle();
            }else if($(this).attr("value")=="TueC3W2-"+$programId){
				$("#ts-avail-c3-w2-1-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w2-1-"+$programId).toggle();
            }
            if($(this).attr("value")=="Wed1C1W1-"+$programId){
				$("#ts-avail-c1-w1-2-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w1-2-"+$programId).toggle();
            }else if($(this).attr("value")=="Wed2C1W2-"+$programId){
				$("#ts-avail-c1-w2-2-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w2-2-"+$programId).toggle();
            }else if($(this).attr("value")=="WedC2W1-"+$programId){
				$("#ts-avail-c2-w1-2-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w1-2-"+$programId).toggle();
            }else if($(this).attr("value")=="WedC2W2-"+$programId){
				$("#ts-avail-c2-w2-2-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w2-2-"+$programId).toggle();
            }else if($(this).attr("value")=="WedC3W1-"+$programId){
				$("#ts-avail-c3-w1-2-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w1-2-"+$programId).toggle();
            }else if($(this).attr("value")=="WedC3W2-"+$programId){
				$("#ts-avail-c3-w2-2-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w2-2-"+$programId).toggle();
            }
			if($(this).attr("value")=="Thu1C1W1-"+$programId){
				$("#ts-avail-c1-w1-3-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w1-3-"+$programId).toggle();
            }else if($(this).attr("value")=="Thu2C1W2-"+$programId){
				$("#ts-avail-c1-w2-3-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w2-3-"+$programId).toggle();
            }else if($(this).attr("value")=="ThuC2W1-"+$programId){
				$("#ts-avail-c2-w1-3-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w1-3-"+$programId).toggle();
            }else if($(this).attr("value")=="ThuC2W2-"+$programId){
				$("#ts-avail-c2-w2-3-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w2-3-"+$programId).toggle();
            }else if($(this).attr("value")=="ThuC3W1-"+$programId){
				$("#ts-avail-c3-w1-3-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w1-3-"+$programId).toggle();
            }else if($(this).attr("value")=="ThuC3W2-"+$programId){
				$("#ts-avail-c3-w2-3-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w2-3-"+$programId).toggle();
            }
			if($(this).attr("value")=="Fri1C1W1-"+$programId){
				$("#ts-avail-c1-w1-4-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w1-4-"+$programId).toggle();
            }else if($(this).attr("value")=="Fri2C1W2-"+$programId){
				$("#ts-avail-c1-w2-4-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w2-4-"+$programId).toggle();
            }else if($(this).attr("value")=="FriC2W1-"+$programId){
				$("#ts-avail-c2-w1-4-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w1-4-"+$programId).toggle();
            }else if($(this).attr("value")=="FriC2W2-"+$programId){
				$("#ts-avail-c2-w2-4-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w2-4-"+$programId).toggle();
            }else if($(this).attr("value")=="FriC3W1-"+$programId){
				$("#ts-avail-c3-w1-4-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w1-4-"+$programId).toggle();
            }else if($(this).attr("value")=="FriC3W2-"+$programId){
				$("#ts-avail-c3-w2-4-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w2-4-"+$programId).toggle();
            }
			if($(this).attr("value")=="Sat1C1W1-"+$programId){
				$("#ts-avail-c1-w1-5-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w1-5-"+$programId).toggle();
            }else if($(this).attr("value")=="Sat2C1W2-"+$programId){
				$("#ts-avail-c1-w2-5-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c1-w2-5-"+$programId).toggle();
            }else if($(this).attr("value")=="SatC2W1-"+$programId){
				$("#ts-avail-c2-w1-5-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w1-5-"+$programId).toggle();
            }else if($(this).attr("value")=="SatC2W2"+$programId){
				$("#ts-avail-c2-w2-5-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c2-w2-5-"+$programId).toggle();
            }else if($(this).attr("value")=="SatC3W1-"+$programId){
				$("#ts-avail-c3-w1-5-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w1-5-"+$programId).toggle();
            }else if($(this).attr("value")=="SatC3W2-"+$programId){
				$("#ts-avail-c3-w2-5-"+$programId).find('option:selected').removeAttr('selected');
				$("#ts-avail-c3-w2-5-"+$programId).toggle();
            }         
	   });
	}
	//function do add exception date in program cycles
function showHideDates(programId) {
	var start_date1 = $('#program_start_date').val();
	var end_date1 = $('#program_end_date').val();
	var cycle1_endweekdate = $('#endweek1-'+programId).val();
	var cycle2_endweekdate = $('#endweek2-'+programId).val();
	
    //for cycle 1
	$("#startweek1-"+programId).datepicker({
		//minDate: start_date1,
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		...
		changeYear: true,
		onSelect: function(selectedDate) {
		    var date2 = $('#startweek1-'+programId).datepicker('getDate');
			date2.setDate(date2.getDate() + 1);
		    $("#endweek1-"+programId).datepicker("option", "minDate", date2);
			$("#exceptnProgAval1-"+programId).datepicker("option", "minDate", selectedDate);
			$("#additionalDayCal1-"+programId).datepicker("option", "minDate", selectedDate);			
			$('#exceptnProgAval1-'+programId).val('');
		}
	});
	$("#endweek1-"+programId).datepicker({
		//maxDate: end_date1,
	    dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		...
		changeYear: true,
		onSelect: function(selectedDate) {
			var date2 = $('#endweek1-'+programId).datepicker('getDate');
			date2.setDate(date2.getDate() + 1);
			$("#startweek2-"+programId).datepicker("option", "minDate", date2);
			$("#exceptnProgAval1-"+programId).datepicker("option", "maxDate", selectedDate);
			$("#additionalDayCal1-"+programId).datepicker("option", "maxDate", selectedDate);
			$('#exceptnProgAval1-'+programId).val('');
		}
	});
	$("#exceptnProgAval1-"+programId).datepicker({
		maxDate: $('#endweek1-'+programId).datepicker('getDate'),
		minDate: $('#startweek1-'+programId).datepicker('getDate'),
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		numberOfMonths: 1,
	...
	$("#additionalDayCal1-"+programId).datepicker({
	maxDate: $('#endweek1-'+programId).datepicker('getDate'),
	minDate: $('#startweek1-'+programId).datepicker('getDate'),
	dateFormat: 'dd-mm-yy',
	defaultDate: "+1w",
	...
	//for cycle 2
	$("#startweek2-"+programId).datepicker({
	   	minDate: $('#endweek1-'+programId).datepicker('getDate'),
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		numberOfMonths: 1,
		...
		changeYear: true,
		onSelect: function(selectedDate) {
			var date2 = $('#startweek2-'+programId).datepicker('getDate');
			date2.setDate(date2.getDate() + 1);
			$("#endweek2-"+programId).datepicker("option", "minDate", date2);
			//$("#endweek2").datepicker("option", "maxDate", end_date1);
			$("#exceptnProgAval2-"+programId).datepicker("option", "minDate", selectedDate);
			$("#additionalDayCal2-"+programId).datepicker("option", "minDate", selectedDate);
			$('#exceptnProgAval2-'+programId).val('');
		}
	});
	$("#endweek2-"+programId).datepicker({
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		numberOfMonths: 1,
		...
		changeYear: true,
		onSelect: function(selectedDate) {
			var date2 = $('#endweek2-'+programId).datepicker('getDate');
			date2.setDate(date2.getDate() + 1);
			$("#startweek3-"+programId).datepicker("option", "minDate", date2);
			$("#exceptnProgAval2-"+programId).datepicker("option", "maxDate", selectedDate);
			$("#additionalDayCal2-"+programId).datepicker("option", "maxDate", selectedDate);
			$('#exceptnProgAval2-'+programId).val('');
		}
	});
	$("#exceptnProgAval2-"+programId).datepicker({
		maxDate: $('#endweek2-'+programId).datepicker('getDate'),
		minDate: $('#startweek2-'+programId).datepicker('getDate'),
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		numberOfMonths: 1,
		...
		$("#additionalDayCal2-"+programId).datepicker({
		maxDate: $('#endweek2-'+programId).datepicker('getDate'),
		minDate: $('#startweek2-'+programId).datepicker('getDate'),
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
	...
	//for cycle 3
	$("#startweek3-"+programId).datepicker({
	    minDate: $('#endweek2-'+programId).datepicker('getDate'),
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		numberOfMonths: 1,
		...
		changeYear: true,
		onSelect: function(selectedDate) {
			var date2 = $('#startweek3-'+programId).datepicker('getDate');
			date2.setDate(date2.getDate() + 1);
			$("#endweek3-"+programId).datepicker("option", "minDate", date2);
			$("#exceptnProgAval3-"+programId).datepicker("option", "minDate", selectedDate);
			$("#additionalDayCal3-"+programId).datepicker("option", "minDate", selectedDate);
			//$("#endweek3").datepicker("option", "maxDate", end_date1);
			$('#exceptnProgAval3-'+programId).val('');
		}
	});
	$("#endweek3-"+programId).datepicker({
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		numberOfMonths: 1,
		...
		changeYear: true,
		onSelect: function(selectedDate) {
			$("#exceptnProgAval3-"+programId).datepicker("option", "maxDate", selectedDate);
			$("#additionalDayCal3-"+programId).datepicker("option", "maxDate", selectedDate);
			$('#exceptnProgAval3-'+programId).val('');
		}
	});
	$("#exceptnProgAval3-"+programId).datepicker({
		maxDate: $('#endweek3-'+programId).datepicker('getDate'),
		minDate: $('#startweek3-'+programId).datepicker('getDate'),
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
		changeMonth: true,
		numberOfMonths: 1,
		...
		$("#additionalDayCal3-"+programId).datepicker({
		maxDate: $('#endweek3-'+programId).datepicker('getDate'),
		minDate: $('#startweek3-'+programId).datepicker('getDate'),
		dateFormat: 'dd-mm-yy',
		defaultDate: "+1w",
...
//end exception date program cycle
//function to add cycle exception
function addExceptionDate(programId) {
	var max_fields = 10; 
	//var maxSerialNum = 0;
	var x = 1,y=0; 
	var exception_date = $('#exceptnProgAval1-'+programId).val();
	//var programId=$('#programId').val();
	var maxSerialNum=parseInt($('#maxSessionListVar-1-'+programId).val(),10);
	if(programId!=""){
		var maxSerialNumVal=maxSerialNum + 1;
...
function addExceptionDateTwo(programId) {
	var max_fields = 10; 
	var x = 1,y=0; 
	var exception_date = $('#exceptnProgAval2-'+programId).val();
	//var programId=$('#programId').val();
	var maxSerialNum=parseInt($('#maxSessionListVar-2-'+programId).val(),10);
	if(programId!=""){
		var maxSerialNumVal=maxSerialNum + 1;
...
function addExceptionDateThree(programId) {	
	var max_fields = 10; 
	var x = 1,y=0; 
	var exception_date = $('#exceptnProgAval3-'+programId).val();
	//var programId=$('#programId').val();
	var maxSerialNum=parseInt($('#maxSessionListVar-3-'+programId).val(),10);
	if(programId!=""){
		var maxSerialNumVal=maxSerialNum + 1;
...
function addAdditionDates(programId) {
   if($("#timeSlot1-"+programId+" option:selected").length <= 0 || $('#additionalDayCal1-'+programId).val() == ''){
		alert('Atleast one timeslot and date needs to be selected for cycle-1.');			
	}else{
		var max_fields = 10; 
		var x = 1,y=0; 
		var additional_date = $('#additionalDayCal1-'+programId).val();
		var time_slot1 = $('#timeSlot1-'+programId).val();	
		var maxSerialNum=parseInt($('#maxSessListVar-1-'+programId).val(),10);
		var maxSerialNumVal=maxSerialNum + 1;
		 $.ajax({
			url: "./ajax_common.php",
			type: "POST",
		...
		if(programId!=""){
			...
			if(additional_date!=''){
				$('#dataaddtables1').append('<tr><td>'+maxSerialNumVal+'</td><td>'+additional_date+'</td><td style="display:none"><input type="hidden" name="additionDate1[]" id="additionDate'+maxSerialNumVal+'" value="'+additional_date+'"/></td><td id="time_slot'+maxSerialNumVal+'"></td><td style="display:none"><input type="hidden" name="time_slot1[]" id="timeslot'+maxSerialNumVal+'" value=""/><input type="hidden" name="actual_time_slot1[]" id="act_timeslot'+maxSerialNumVal+'" value=""/></td><td id='+maxSerialNumVal+'><a class="remove_field" onclick="deleteAddProgCycle(0,'+maxSerialNumVal+')">Remove</a></td></tr></tbody></table></div>');
				$('#additionalDayCal1-'+programId).val('');
				$('#timeSlot1-'+programId).val('');
			}
		}
	}
}
function addAdditionDatesCycleTwo(programId) {
   if($('#timeSlot2-'+programId+' option:selected').length <= 0 || $('#additionalDayCal2-'+programId).val() == ''){
			alert('Atleast one timeslot and date needs to be selected for cycle-2');			
	}else{
		var max_fields = 10; 
		var x = 1,y=0; 
		var additional_date = $('#additionalDayCal2-'+programId).val();
		var time_slot2 = $('#timeSlot2-'+programId).val();
		var maxSerialNum=parseInt($('#maxSessListVar-2-'+programId).val(),10);
		var maxSerialNumVal=maxSerialNum + 1;
		 $.ajax({
			url: "./ajax_common.php",
			type: "POST",
		...
		if(programId!=""){
			...
			if(additional_date!=''){
				$('#dataaddtables2').append('<tr><td>'+maxSerialNumVal+'</td><td>'+additional_date+'</td><td style="display:none"><input type="hidden" name="additionDate2[]" id="additionDate'+maxSerialNumVal+'" value="'+additional_date+'"/></td><td id="time_slot2'+maxSerialNumVal+'"></td><td style="display:none"><input type="hidden" name="time_slot2[]" id="timeslot2'+maxSerialNumVal+'" value=""/><input type="hidden" name="actual_time_slot2[]" id="act_timeslot2'+maxSerialNumVal+'" value=""/></td><td id='+maxSerialNumVal+'><a class="remove_field" onclick="deleteAddProgCycle(0,'+maxSerialNumVal+')">Remove</a></td></tr></tbody></table></div>');
				$('#additionalDayCal2-'+programId).val('');
				$('#timeSlot2-'+programId).val('');
			}
		}
	}	
}
function addAdditionDatesCycleThree(programId) {
    if($("#timeSlot3-"+programId+" option:selected").length <= 0 || $('#additionalDayCal3-'+programId).val() == ''){
			alert('Atleast one timeslot and date needs to be selected for cycle-3');			
	}else{
		var max_fields = 10; 
		var x = 1,y=0; 
		var additional_date = $('#additionalDayCal3-'+programId).val();
		var time_slot3 = $('#timeSlot3-'+programId).val();
		var maxSerialNum=parseInt($('#maxSessListVar-3-'+programId).val(),10);
		var maxSerialNumVal=maxSerialNum + 1;
		 $.ajax({
			url: "./ajax_common.php",
			type: "POST",
		...
		if(programId!=""){
			...
			if(additional_date!=''){
				$('#dataaddtables3').append('<tr><td>'+maxSerialNumVal+'</td><td>'+additional_date+'</td><td style="display:none"><input type="hidden" name="additionDate3[]" id="additionDate'+maxSerialNumVal+'" value="'+additional_date+'"/></td><td id="time_slot3'+maxSerialNumVal+'"></td><td style="display:none"><input type="hidden" name="time_slot3[]" id="timeslot3'+maxSerialNumVal+'" value=""/><input type="hidden" name="actual_time_slot3[]" id="act_timeslot3'+maxSerialNumVal+'" value=""/></td><td id='+maxSerialNumVal+'><a class="remove_field" onclick="deleteAddProgCycle(0,'+maxSerialNumVal+')">Remove</a></td></tr></tbody></table></div>');
				$('#additionalDayCal3-'+programId).val('');
				$('#timeSlot3-'+programId).val('');
			}
		}
	}
}
