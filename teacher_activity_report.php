...
if(isset($_POST['btnGenrtReport']) && $_POST['btnGenrtReport'] != '')
{
	if($_POST['fromTmDuratn'] != "" || $_POST['toTmDuratn'] != "")
	{
		...
		$result = $objTime->getTeachersActivityInRange($_POST['fromTmDuratn'],$_POST['toTmDuratn'],$teacher_id,$program_id,$area_id,$profesor_id,$cycle_id,$module);	
	}else{		
...
<div id="content">
    ...
    <?php if(isset($_SESSION['succ_msg'])){ echo '<div class="full_w green center">'.$_SESSION['succ_msg'].'</div>'; $_SESSION['succ_msg']="";} ?>
		...
		<?php } ?>		
		<form id="teacher_report" name="teacher_report" method="post" action="teacher_activity_report.php" novalidate="novalidate">
            ...
            <table id="datatables" class="display printable">
                <thead>
                    <tr>
                        ...
                        <th>Case No</th>
						<th width="20">Technical Notes</th>
