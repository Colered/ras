						...
						<div style="width:700px;float:left;" >
							 ...
							 ?>
								  <tr>
									...
									<td align="center"><input type="checkbox" id="add<?php echo $check_arr[$i]['page_id']?>" name="page<?php echo $check_arr[$i]['page_id']?>[]" value="add-<?php echo $check_arr[$i]['page_id']?>" class="cls-permission" <?php if($check_arr[$i]['add_role']==1){echo "checked";}  ?> <?php if($check_arr[$i]['page_id']==3 || $check_arr[$i]['page_id']==4 || $check_arr[$i]['page_id']==13 || $check_arr[$i]['page_id']==17 || $check_arr[$i]['page_id']==1 || $check_arr[$i]['page_id']==24 || $check_arr[$i]['page_id']==25 || $check_arr[$i]['page_id']==26 || $check_arr[$i]['page_id']==20 || $check_arr[$i]['page_id']==2 || $check_arr[$i]['page_id']==21  || $check_arr[$i]['page_id']==22 || $check_arr[$i]['page_id']==23){echo "disabled";}  ?>/></td>
									...
									<td align="center"><input type="checkbox" id="delete<?php echo $check_arr[$i]['page_id']?>" name="page<?php echo $check_arr[$i]['page_id']?>[]"  value="delete-<?php echo $check_arr[$i]['page_id']?>" class="cls-permission" <?php if($check_arr[$i]['delete_role']==1){echo "checked";} ?> <?php if($check_arr[$i]['page_id']==3 || $check_arr[$i]['page_id']==4 || $check_arr[$i]['page_id']==13 || $check_arr[$i]['page_id']==1 || $check_arr[$i]['page_id']==24 || $check_arr[$i]['page_id']==25 || $check_arr[$i]['page_id']==26 || $check_arr[$i]['page_id']==20 || $check_arr[$i]['page_id']==21  || $check_arr[$i]['page_id']==22 || $check_arr[$i]['page_id']==23){echo "disabled";}  ?>/></td>
