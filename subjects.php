        ...
        <div class="full_w">
            ...
            <form action="" method="post">
                <div class="custtable_left">
                    ...
                    <div class="txtfield">
                        <input type="text" class="inp_txt" id="txtSubjname" maxlength="50" name="txtSubjname">
                    </div>
                    <div class="clear"></div>
                    <div class="custtd_left">
                    ...
                    <div class="txtfield">
                        <input type="text" class="inp_txt" id="txtSubjCode" maxlength="50" name="txtSubjCode">
                    </div>
                    <div class="clear"></div>
                    <div class="custtd_left">
                    ...
                    <div class="txtfield">
                        <select id="slctArea" name="slctArea" class="select1">
                    ...
                    <div class="txtfield">
                        <input type="text" class="inp_txt" id="txtSessionNum" maxlength="50" name="txtSessionNum">
                    </div>
                    <div class="clear"></div>
                    <div class="custtd_left">
                    ...
                    <div class="txtfield">
                        <input type="text" class="inp_txt" id="txtCaseNum" maxlength="50" name="txtCaseNum">
                    </div>
                    <div class="clear"></div>
                    <div class="custtd_left">
                    ...
                    <div class="txtfield">
                        <textarea style="height:40px;" class="inp_txt" id="txtTechNotes" cols="20" rows="2" name="txtTechNotes"></textarea>
                    </div>
                    <div class="clear"></div>
                    <div class="custtd_left">
                    ...
                    <div class="txtfield">
                        <input type="button" name="btnAddSubject" class="buttonsub" value="Add Subject">
                    </div>
                    <div class="txtfield">
