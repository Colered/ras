					    ...
					    $count = 0;
					   	while($data = $classroomAvailData->fetch_assoc()){
							if($count%6 == 0){ echo "<tr>"; }?>
								<td class="sched-data"><div style="word-wrap: break-word; overflow-y: scroll; height: 300px;"><li class="main-title"><input type="checkbox" name="ckbruleVal[]" value="<?php echo $data['id']; ?>" <?php if(in_array($data['id'], $mappedruleids)) { echo "checked"; } ?>  /><b>&nbsp;<?php echo $data['rule_name']; ?></b>
