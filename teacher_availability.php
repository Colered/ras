					    ...
					    $count = 0;
					   	while($data = $teacherAvailData->fetch_assoc()){
							if($count%6 == 0){ echo "<tr>"; }?>
								...
								<span style="padding-left:10px; cursor:pointer; padding-top:5px;"><img alt="Delete Rule" style="margin-bottom:-3px;" onclick="deleteRuleTeacher(<?php echo $data['id']; ?>);" src="images/delete-rule.png" /></span>
								</li>
