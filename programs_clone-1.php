	...
	<div class="full_w">
		...
		<div class="full_w">		
			<div class="h_title">Program Cycles <?php echo $row['name'];?></div>			
				...
				<div class="txtfield">
					<select id="slctNumCycle-<?php echo $program_year_id;?>" name="programcycles[<?php echo $program_year_id;?>][slctNumcycle]" class="select" <?php if(isset($cycleIdsArr) && count($cycleIdsArr)>0){ echo "readonly"; }?> onchange="show_hide_cycle_clone(this.value,<?php echo $program_year_id;?>)">
				...
				<div id="firstCycle-<?php echo $program_year_id;?>" style="display:none;border:1px solid #CCCCCC; padding:20px; 20px 20px 20px; margin-bottom:10px; width:1200px">
                    ...
                    <div class="txtfield">
                        <select id="c1chWeek1-<?php echo $program_year_id;?>" name="programcycles[<?php echo $program_year_id;?>][c1chWeek1]" class="select required" onchange="showCycleDetailsclone(this.value,<?php echo $program_year_id;?>);">
					...
					<div class="txtfield">
						<div id="c1week1-<?php echo $program_year_id;?>" style="display:none;">
							<div class="tmSlotc1w1-<?php echo $program_year_id;?> tmSlotc1w1">
					...
					<div class="txtfield">
						<div id="c1week2-<?php echo $program_year_id;?>" style="display:none;">
							<div class="tmSlotc1w2 tmSlotc1w2-<?php echo $program_year_id;?>">
				...
				<div id="secondCycle-<?php echo $program_year_id;?>" style="display:none;border:1px solid #CCCCCC; padding:20px; 20px 20px 20px; margin-bottom:10px; width:1200px">
					...
					<div class="custtd_left"><h2>Occurring<span class="redstar">*</span></h2></div>
					<div class="txtfield">
						<select id="c1chWeek2-<?php echo $program_year_id;?>" name="programcycles[<?php echo $program_year_id;?>][c1chWeek2]" class="select required" onchange="showCycleDetailstwoclone(this.value,<?php echo $program_year_id;?>);">
							<option value="">--Select Week--</option>
					...
					<div class="txtfield">
						<div id="c2week1-<?php echo $program_year_id;?>" style="display:none;">
							<div class="tmSlotc2w1 tmSlotc2w1-<?php echo $program_year_id;?>">
					...
					<div class="txtfield">
						<div id="c2week2-<?php echo $program_year_id;?>" style="display:none;">
							<div class="tmSlotc2w2 tmSlotc2w2-<?php echo $program_year_id;?>">
				...
				<div id="thirdCycle-<?php echo $program_year_id;?>" style="display:none;border:1px solid #CCCCCC; padding:20px; 20px 20px 20px; margin-bottom:10px; width:1200px">
					<div class="custtd_left"><h2>3rd cycle<span class="redstar">*</span></h2></div>
						...
						<div class="custtd_left"><h2>Occurring<span class="redstar">*</span></h2></div>
						<div class="txtfield">
							<select id="c1chWeek3-<?php echo $program_year_id;?>" name="programcycles[<?php echo $program_year_id;?>][c1chWeek3]" class="select required" onchange="showCycleDetailsthreeclone(this.value,<?php echo $program_year_id;?>);">
								<option value="">--Select Week--</option>
						...
						<div class="txtfield">
							<div id="c3week1-<?php echo $program_year_id;?>" style="display:none;">
								<div class="tmSlotc3w1 tmSlotc3w1-<?php echo $program_year_id;?>">
						...
						<div class="txtfield">
							<div id="c3week2-<?php echo $program_year_id;?>" style="display:none;">
								<div class="tmSlotc3w2 tmSlotc3w2-<?php echo $program_year_id;?>">
		...
		<input type="hidden" name="program_year_id" id="program_year_id" value="<?php echo rtrim($pgm_year_id,',');?>">
		<!-- add program cycles-->
		<div class="clear"></div>
		</form>
    </div><!--end main div-->
